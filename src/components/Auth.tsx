    ...
    <div className=" w-auto min-h-screen flex justify-center items-center ">
      <div className=" bg-blueBg shadow-md border border-main rounded-lg h-5/6 max-w-sm p-4">
        ...
        <div className="flex justify-between my-5">
          ...
          {!signUp && (
            <Link to={routs.FORGETPASSWORD} className="textStyle text-sm ">
              Lost Password?
            </Link>
          )}
        </div>
        ...
        <div className="flex justify-between px-5 mt-3">
          ...
          <Link
            to={routs.ADMIN_SIGNIN}
            className="textStyle text-right text-white"
          >
            Admin Login
          </Link>
        </div>
        <div className="textStyle text-white mt-5">
          ...
          {signUp ? (
            <Link to={routs.SIGN_IN} className="text-main">
              Sign In
            </Link>
          ) : (
            <Link to={routs.SIGN_UP} className="text-main">
              Create Account
            </Link>
          )}
        </div>
